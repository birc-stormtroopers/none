...
You can rarely get rid of *all* references to special cases, and we didn't achieve that here either, but if you can move them away from the main algorithm you have made a substantial improvement.
